...
The missing-modality decay notebook produces four complementary output views. The examples below use the mmCRC global missingness setting, but the same structure is generated for any dataset/run configuration.

#### Output View 1: Mean AUC Decay Curves
